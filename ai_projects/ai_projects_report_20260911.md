...
### 1. 中文简介
routeVSCODE 是一个基于 9Router 的 VSCode 插件，可作为本地代理实现 AI 模型的热切换，无需重启即可动态切换 Copilot Chat 所连接的模型。

### 2. 核心功能
- **零重启热切换**：无需重新加载 VSCode，即可动态切换 AI 模型
- **本地代理转发**：通过本地代理路由 VSCode Copilot Chat 的请求
- **多模型支持**：兼容 ChatGPT、Claude、DeepSeek、Copilot 等多种 AI 模型
- **VSCode 插件集成**：以扩展形式无缝嵌入 VSCode 编辑器

### 3. 适用场景
- 开发者希望在 VSCode 中自由切换不同 AI 模型以获取最佳代码建议
- 需要访问受限地区 AI 服务的用户，通过本地代理绕过限制
- 希望在一款编辑器内同时使用多个 AI 模型进行对比测试
- 本地部署 AI 模型并作为 Copilot Chat 后端代理的场景

### 4. 技术亮点
- 基于 9Router 架构实现轻量级本地代理，无需额外服务器部署
- 利用 VSCode 插件机制实现零重启热切换，提升用户体验
- 统一代理接口支持多种主流 AI 模型，降低多模型使用门槛
...
### tessra
- 描述: The version control system for the era of AI.
- 链接: https://github.com/NitrusAphalion/tessra
- ⭐ 10 | 🍴 1 | 语言: Rust
- 标签: ai, ai-agents, ai-tools, git, swarm
...
- ⭐ 74709 | 🍴 9147 | 语言: Python
- 标签: agent, ai, deepseek, fine-tuning, gemma

### AI-For-Beginners
- 描述: 12 Weeks, 24 Lessons, AI for All!
- 链接: https://github.com/microsoft/AI-For-Beginners
- ⭐ 68372 | 🍴 13193 | 语言: Jupyter Notebook
- 标签: ai, artificial-intelligence, cnn, computer-vision, deep-learning

### ai-engineering-from-scratch
- 描述: Learn it. Build it. Ship it for others.
- 链接: https://github.com/rohitg00/ai-engineering-from-scratch
- ⭐ 54204 | 🍴 9450 | 语言: Python
