...
### 1. 中文简介
ToolReplay 是一款用于审计 AI 智能体工具调用记录的 Python 命令行工具。它通过哈希链技术对调用日志进行密封，支持确定性重放，并能检测作用域越界行为。该工具无需任何外部依赖，开箱即用。

### 2. 核心功能
- **哈希链密封**：使用哈希链对工具调用记录进行加密密封，确保数据完整性与不可篡改性
- **确定性重放**：支持对历史工具调用进行精确重放，便于复现和分析问题
- **作用域越界检测**：自动检查 AI 智能体是否超出授权范围调用工具
- **JSONL 格式支持**：以 JSONL 格式存储和解析工具调用记录
- **零依赖运行**：纯 Python 实现，无需安装额外依赖包

### 3. 适用场景
- **AI 智能体安全审计**：审查 AI 代理的工具调用行为，确保其遵循安全策略
- **合规性检查**：验证 AI 系统是否符合权限管理和数据使用规范
- **问题排查与复现**：通过重放功能复现 AI 智能体的决策过程，定位异常行为
- **权限边界监控**：检测 AI 工具调用是否存在作用域越界风险

### 4. 技术亮点
- 采用哈希链技术实现调用记录的不可篡改审计，为 AI 安全提供可信验证机制
- 无依赖设计使其易于集成到各种环境中，部署成本低
- 确定性重放功能为 AI 行为分析提供了精确的调试能力
...
### legal-ai-chatbot
- 描述: русский "юридический" чат-бот для интеграции в Tilda
- 链接: https://github.com/AntoGA/legal-ai-chatbot
- ⭐ 21 | 🍴 0 | 语言: JavaScript
...
- ⭐ 74764 | 🍴 9155 | 语言: Python
- 标签: agent, ai, deepseek, fine-tuning, gemma

### AI-For-Beginners
- 描述: 12 Weeks, 24 Lessons, AI for All!
- 链接: https://github.com/microsoft/AI-For-Beginners
- ⭐ 68477 | 🍴 13227 | 语言: Jupyter Notebook
- 标签: ai, artificial-intelligence, cnn, computer-vision, deep-learning

### ai-engineering-from-scratch
- 描述: Learn it. Build it. Ship it for others.
- 链接: https://github.com/rohitg00/ai-engineering-from-scratch
- ⭐ 54528 | 🍴 9539 | 语言: Python
- 标签: agents, ai, ai-agents, ai-engineering, computer-vision

### ailearning
- 描述: AiLearning：数据分析+机器学习实战+线性代数+PyTorch+NLTK+TF2
- 链接: https://github.com/apachecn/ailearning
- ⭐ 42529 | 🍴 11506 | 语言: Python
...
- ⭐ 29481 | 🍴 3610 | 语言: Jupyter Notebook
- 标签: agentic-rag, ai, embeddings, generative-ai, gpt

### datasets
- 描述: 🤗 The largest hub of ready-to-use datasets for AI models with fast, easy-to-use and efficient data manipulation tools
- 链接: https://github.com/huggingface/datasets
- ⭐ 21968 | 🍴 3421 | 语言: Python
