...
routeVSCODE 是一款 VSCode 扩展，通过 9Router 实现零重启动态切换 AI 模型，为 Copilot Chat 提供本地代理服务，支持多种主流 AI 模型无缝切换。

### 2. 核心功能

- **零重启模型切换**：无需重新加载 VSCode，即可动态切换 AI 模型
- **本地代理支持**：通过本地代理转发请求，增强隐私与可控性
- **多模型兼容**：支持 ChatGPT、Claude、Copilot、DeepSeek 等多种 AI 模型
- **VSCode 深度集成**：作为 VSCode 扩展，无缝融入 Copilot Chat 工作流
- **灵活路由配置**：基于 9Router 实现智能请求路由与负载均衡

### 3. 适用场景

- **多模型对比测试**：开发者在同一会话中快速切换不同 AI 模型，对比回答质量
- **模型故障切换**：当某一模型服务不可用时，自动或手动切换到备用模型
- **成本优化**：根据任务需求选择不同性价比的模型，降低 API 使用成本
- **隐私敏感场景**：通过本地代理拦截和转发请求，保护代码与对话数据

### 4. 技术亮点

- 基于 9Router 构建轻量级本地代理，实现请求级路由控制
- 支持热切换，无需重启 VSCode 即可生效，提升用户体验
- 扩展架构简洁，仅使用 JavaScript 实现，易于二次开发和维护
...
### ai-security-tool
- 描述: Free open-source AI-powered security terminal & vulnerability scanner (CVE, SBOM). Supports SSH, SFTP, RDP, VNC, Serial, and 12+ autonomous AI agents (DeepSeek, OpenAI) for automated security workflows, CTF & DevSecOps. Cross-platform & Web UI.
- 链接: https://github.com/ZeroDayEvil/ai-security-tool
- ⭐ 13 | 🍴 6 | 语言: HTML
- 标签: ai-agent, ctf, cve, cve-scanner, cybersecurity
...
- ⭐ 74710 | 🍴 9147 | 语言: Python
- 标签: agent, ai, deepseek, fine-tuning, gemma

### AI-For-Beginners
- 描述: 12 Weeks, 24 Lessons, AI for All!
- 链接: https://github.com/microsoft/AI-For-Beginners
- ⭐ 68373 | 🍴 13195 | 语言: Jupyter Notebook
- 标签: ai, artificial-intelligence, cnn, computer-vision, deep-learning

### ai-engineering-from-scratch
- 描述: Learn it. Build it. Ship it for others.
- 链接: https://github.com/rohitg00/ai-engineering-from-scratch
- ⭐ 54218 | 🍴 9453 | 语言: Python
...
- ⭐ 29439 | 🍴 3605 | 语言: Jupyter Notebook
- 标签: agentic-rag, ai, embeddings, generative-ai, gpt

### datasets
- 描述: 🤗 The largest hub of ready-to-use datasets for AI models with fast, easy-to-use and efficient data manipulation tools
- 链接: https://github.com/huggingface/datasets
- ⭐ 21966 | 🍴 3414 | 语言: Python
