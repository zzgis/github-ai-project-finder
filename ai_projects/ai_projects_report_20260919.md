...
### 1. 中文简介
这是一个经过精心筛选、附有来源链接的开源项目列表，专注于基于 **Jev** 构建的项目。Jev 是 TypeSafe AI 推出的 **System One 模型**，专为类型安全的决策场景而设计。

### 2. 核心功能
- 收录基于 Jev 框架构建的各类开源项目，提供来源验证。
- 聚焦"类型安全 AI 决策"方向，涵盖结构化输出与置信度感知 AI。
- 整合 LLM 护栏（Guardrails）、模型路由（Model Routing）等关键技术。
- 为 AI Agent 开发提供可复用的决策智能方案参考。
- 以 Awesome List 形式呈现，便于快速浏览和查找相关项目。

### 3. 适用场景
- 需要构建**类型安全、结构化输出**的 AI 决策系统。
- 开发 **AI Agent** 时，希望引入置信度感知与模型路由机制。
- 为 LLM 应用添加**护栏层（Guardrails）**，防止输出偏离预期类型。
- 研究或落地 **决策智能（Decision Intelligence）** 相关技术。

### 4. 技术亮点
- **System One 模型架构**：TypeSafe AI 提出的专为类型安全决策设计的底层模型方案。
- **置信度感知 AI**：项目列表涵盖对模型输出置信度进行评估的技术实践。
- **结构化输出保障**：强调通过类型系统约束 LLM 输出，降低幻觉风险。
- **开源生态整合**：汇聚多个相关项目，形成从模型到应用的全链路参考。
...
### copilot
- 描述: Apex Copilot CLI — AI coding agent
- 链接: https://github.com/apexaccs/copilot
- ⭐ 16 | 🍴 0 | 语言: TypeScript

### AutoCAD-Cracked
- 描述: The ultimate AI-powered CAD design software. AutoCAD — Full version with all premium features unlocked. Experience advanced 2D/3D drafting, AI tools and professional design without limitations.
- 链接: https://github.com/Labeldatreasure/AutoCAD-Cracked
- ⭐ 16 | 🍴 0 | 语言: 未知
...
- ⭐ 74885 | 🍴 9174 | 语言: Python
- 标签: agent, ai, deepseek, fine-tuning, gemma

### AI-For-Beginners
- 描述: 12 Weeks, 24 Lessons, AI for All!
- 链接: https://github.com/microsoft/AI-For-Beginners
- ⭐ 68722 | 🍴 13276 | 语言: Jupyter Notebook
- 标签: ai, artificial-intelligence, cnn, computer-vision, deep-learning

### ai-engineering-from-scratch
- 描述: Learn it. Build it. Ship it for others.
- 链接: https://github.com/rohitg00/ai-engineering-from-scratch
- ⭐ 55002 | 🍴 9667 | 语言: Python
